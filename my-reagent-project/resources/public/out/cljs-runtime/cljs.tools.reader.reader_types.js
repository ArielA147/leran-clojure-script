...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_40781 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_40781(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_40782 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_40782(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40784 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40784(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40789 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40789(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40790 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40790(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40791 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40791(reader);
}
});
...
var G__40827 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__40828 = s.append(c);
c = G__40827;
s = G__40828;
continue;
}
