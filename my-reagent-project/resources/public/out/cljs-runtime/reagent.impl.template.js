...
var G__50830 = o;
goog.object.set(G__50830,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__50849__i < G__50849__a.length) {G__50849__a[G__50849__i] = arguments[G__50849__i + 0]; ++G__50849__i;}
  args = new cljs.core.IndexedSeq(G__50849__a,0,null);
} 
...
var args = cljs.core.seq(arglist__50850);
...
var G__50831 = o;
goog.object.set(G__50831,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__50851__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__50852__i < G__50852__a.length) {G__50852__a[G__50852__i] = arguments[G__50852__i + 0]; ++G__50852__i;}
  args = new cljs.core.IndexedSeq(G__50852__a,0,null);
} 
return G__50851__delegate.call(this,args);};
G__50851.cljs$lang$maxFixedArity = 0;
G__50851.cljs$lang$applyTo = (function (arglist__50853){
var args = cljs.core.seq(arglist__50853);
return G__50851__delegate(args);
});
...
var G__50832 = props;
var G__50832__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50832,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50832);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50832__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__50833 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50833,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__50833;
}
})(),id_class);
...
var G__50834 = (cljs.core.count(argv) - first_child);
switch (G__50834) {
case (0):
...
var vec__50835 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50835,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50835,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50835,(2),null);
...
var temp__5757__auto___50883 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___50883 == null)){
} else {
var key_50884 = temp__5757__auto___50883;
(jsprops.key = key_50884);
}
...
var temp__5757__auto___50885 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___50885 == null)){
} else {
var key_50886 = temp__5757__auto___50885;
(jsprops.key = key_50886);
}
...
var temp__5757__auto___50887 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___50887 == null)){
} else {
var key_50888 = temp__5757__auto___50887;
(jsprops.key = key_50888);
}
...
var temp__5757__auto___50889 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___50889 == null)){
} else {
var key_50890 = temp__5757__auto___50889;
(jsprops.key = key_50890);
}
...
var temp__5757__auto___50891 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___50891 == null)){
} else {
var key_50892 = temp__5757__auto___50891;
(jsprops.key = key_50892);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50838_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__50838_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__50839 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50839,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50839,(1),null);
...
break;
default:
var G__50894 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__50895 = compiler;
v = G__50894;
compiler = G__50895;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template50845 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template50845 = (function (opts,id,fn_to_element,parse_fn,meta50846){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template50845.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_50847,meta50846__$1){
var self__ = this;
var _50847__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template50845(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta50846__$1));
}));

(reagent.impl.template.t_reagent$impl$template50845.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_50847){
var self__ = this;
var _50847__$1 = this;
return self__.meta50846;
}));

(reagent.impl.template.t_reagent$impl$template50845.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template50845.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template50845.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template50845.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template50845.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template50845.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta50846","meta50846",1581619919,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template50845.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template50845.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template50845");

(reagent.impl.template.t_reagent$impl$template50845.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template50845");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template50845.
 */
reagent.impl.template.__GT_t_reagent$impl$template50845 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template50845(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta50846){
return (new reagent.impl.template.t_reagent$impl$template50845(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta50846));
});

}

return (new reagent.impl.template.t_reagent$impl$template50845(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
